...
public interface OrderSystem {
    ...
    interface KeyValue {
        ...
        /**
         * 返回long形式的值 类型转换失败则抛出TypeException异常
         * 
         * @return
         * @throws TypeException
         */
        ...
        /**
         * 返回double形式的值 测试程序邀请浮点数精度保证至小数点后6位 类型转换失败则抛出TypeException异常
         */
        public double valueAsDouble() throws TypeException;

        /**
         * 只有 true, false字符串能被转换为boolean类型，其他值调用asBoolean则抛出TypeException
         * [String] true -> [Boolean] true [String] false -> [Boolean] false
         * [String] True -> TypeException [String] False -> TypeException
         */
     ...
     */
    Iterator<com.alibaba.middleware.race.model.Result> queryOrdersByBuyer(
     ...
     */
    Iterator<com.alibaba.middleware.race.model.Result> queryOrdersBySaler(
